...
function Employee(name, email, hireDate) {
  ...
  */
  ...
  let mark = new User('Mark', 31, 'markallencarey@gmail.com', [])
  console.log(mark)

  mark.addSavedPost(1, 'My First Post', 4)
  console.log(mark)
  mark.addSavedPost(2, 'My Second Post', 3)
  console.log(mark)
  ...
  User.prototype.changePostRating = function(id, newRating) {
    this.savedPosts.id = id
    this.savedPosts.newRating = newRating
